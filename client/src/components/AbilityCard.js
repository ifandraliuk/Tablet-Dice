  ...
  return (
    ...
    >
      ...
      <div className="row m-0 p-0 ">
        <Image src={`/abilities/${userclass && userclass}/${_id}.svg`}></Image>
      </div>
      <div
      ...
      <div className="row">
        ...
        <MotionButton 
              name={_id}
              content={props.buttonText ? props.buttonText : "Verwenden"}
              onClick={props?.customClick ? props.customClick : onClick}
              theme=""
            />
