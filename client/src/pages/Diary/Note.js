...
function Note(props) {
    const {note, onEdit, onRemove} = props
            ...
            <div className="col-lg-8 col-xl-8 col-md-11 note-body">
                ...
                <div className='row'>
                    ...
                    <div className="col-auto d-flex justify-content-end">
                        ...
                        <button className='btn-edit' id={note._id} onClick={onEdit}><FontAwesomeIcon icon={faMarker} /></button> 
                    <button className="btn-remove" id={note._id} onClick={onRemove}><FontAwesomeIcon icon={faTrash} /></button> </div>
                    </div>
