...
const {getPlayer, setAttributes, getGeneral, setGeneral, addClass, putTalent, updateInventory, deleteItem} = require('../controllers/playerController')
...
router.route('/inventory').put(protect, updateInventory)
